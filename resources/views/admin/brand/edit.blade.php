...
<!--       @if ($errors->any())
      ...
      @endif -->
    	...
    	<form class="layui-form" action="{{url('/brand/update/'.$brand->brand_id)}}" method="post" enctype="multipart/form-data">
    		@csrf
		  ...
		  <div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <input type="text" name="brand_desc" value="{{$brand->brand_desc}}" lay-verify="title" autocomplete="off" placeholder="请输入品牌简介" class="layui-input">
          <!-- 验证提示信息 -->
